...
cd "$NETWORK_DIR"
echo "升级 invoice 链码：Version 1.5 / Sequence 6 → Version 1.6 / Sequence 7"
bash ./network.sh deployCC -c mychannel -ccn invoice -ccp "$PROJECT_ROOT/chaincode" -ccl go -ccv 1.6 -ccs 7
