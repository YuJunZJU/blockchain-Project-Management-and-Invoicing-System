...
cd "$NETWORK_DIR"
echo "升级 invoice 链码：Version 1.6 / Sequence 7 → Version 1.7 / Sequence 8"
bash ./network.sh deployCC -c mychannel -ccn invoice -ccp "$PROJECT_ROOT/chaincode" -ccl go -ccv 1.7 -ccs 8
