...
cd "$NETWORK_DIR"
echo "升级 invoice 链码：Version 1.7 / Sequence 1 → Version 1.8 / Sequence 2"
bash ./network.sh deployCC -c mychannel -ccn invoice -ccp "$PROJECT_ROOT/chaincode" -ccl go -ccv 1.8 -ccs 2
