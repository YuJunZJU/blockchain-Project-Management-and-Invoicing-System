...
cd "$NETWORK_DIR"
echo "升级 invoice 链码：Version 1.2 / Sequence 3 → Version 1.3 / Sequence 4"
bash ./network.sh deployCC -c mychannel -ccn invoice -ccp "$PROJECT_ROOT/chaincode" -ccl go -ccv 1.3 -ccs 4
