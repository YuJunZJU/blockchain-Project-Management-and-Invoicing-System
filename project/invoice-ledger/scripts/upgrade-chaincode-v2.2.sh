...
cd "$NETWORK_DIR"
echo "升级 invoice 链码：Version 2.1 / Sequence 3 → Version 2.2 / Sequence 4"
bash ./network.sh deployCC -c mychannel -ccn invoice -ccp "$PROJECT_ROOT/chaincode" -ccl go -ccv 2.2 -ccs 4
